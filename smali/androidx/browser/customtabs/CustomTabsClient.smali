...
# direct methods
.method public constructor <init>(Ld;Landroid/content/ComponentName;Landroid/content/Context;)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Landroidx/browser/customtabs/CustomTabsClient;->mService:Ld;
...
.method private createCallbackWrapper(Landroidx/browser/customtabs/CustomTabsCallback;)Lc$a;
    .locals 1
...
.method private newSessionInternal(Landroidx/browser/customtabs/CustomTabsCallback;Landroid/app/PendingIntent;)Landroidx/browser/customtabs/CustomTabsSession;
    ...
    .line 1
    invoke-direct {p0, p1}, Landroidx/browser/customtabs/CustomTabsClient;->createCallbackWrapper(Landroidx/browser/customtabs/CustomTabsCallback;)Lc$a;
    ...
    .line 4
    iget-object v2, p0, Landroidx/browser/customtabs/CustomTabsClient;->mService:Ld;

    invoke-interface {v2, p1, v1}, Ld;->newSessionWithExtras(Lc;Landroid/os/Bundle;)Z
    ...
    .line 5
    :cond_0
    iget-object v1, p0, Landroidx/browser/customtabs/CustomTabsClient;->mService:Ld;

    invoke-interface {v1, p1}, Ld;->newSession(Lc;)Z
    ...
    invoke-direct {v0, v1, p1, v2, p2}, Landroidx/browser/customtabs/CustomTabsSession;-><init>(Ld;Lc;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
...
.method public extraCommand(Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Landroidx/browser/customtabs/CustomTabsClient;->mService:Ld;

    invoke-interface {v0, p1, p2}, Ld;->extraCommand(Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
...
.method public warmup(J)Z
    ...
    invoke-interface {v0, p1, p2}, Ld;->warmup(J)Z
