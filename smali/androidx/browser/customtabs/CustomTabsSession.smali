...
# instance fields
.field public final mCallback:Lc;
...
.field public final mService:Ld;


# direct methods
.method public constructor <init>(Ld;Lc;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
    .locals 1
    ...
    .line 3
    iput-object p1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:Ld;

    .line 4
    iput-object p2, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lc;
...
.method public static createMockSessionForTesting(Landroid/content/ComponentName;)Landroidx/browser/customtabs/CustomTabsSession;
    ...
    invoke-direct {v0, v1, v2, p0, v3}, Landroidx/browser/customtabs/CustomTabsSession;-><init>(Ld;Lc;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
...
.method public getBinder()Landroid/os/IBinder;
    ...
    .line 1
    iget-object v0, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lc;
...
.method public mayLaunchUrl(Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
    ...
    .line 2
    :try_start_0
    iget-object v0, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:Ld;

    iget-object v1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lc;

    invoke-interface {v0, v1, p1, p2, p3}, Ld;->mayLaunchUrl(Lc;Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
...
.method public postMessage(Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    .line 3
    :try_start_0
    iget-object v1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:Ld;

    iget-object v2, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lc;

    invoke-interface {v1, v2, p1, p2}, Ld;->postMessage(Lc;Ljava/lang/String;Landroid/os/Bundle;)I
...
.method public receiveFile(Landroid/net/Uri;ILandroid/os/Bundle;)Z
    ...
    invoke-interface {v0, v1, p1, p2, p3}, Ld;->receiveFile(Lc;Landroid/net/Uri;ILandroid/os/Bundle;)Z
...
.method public requestPostMessageChannel(Landroid/net/Uri;)Z
    ...
    .line 4
    invoke-interface {v0, v1, p1, v2}, Ld;->requestPostMessageChannelWithExtras(Lc;Landroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    invoke-interface {v0, v1, p1}, Ld;->requestPostMessageChannel(Lc;Landroid/net/Uri;)Z
...
.method public setActionButton(Landroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    .line 7
    :try_start_0
    iget-object p2, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:Ld;

    iget-object v0, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lc;

    invoke-interface {p2, v0, p1}, Ld;->updateVisuals(Lc;Landroid/os/Bundle;)Z
...
.method public setSecondaryToolbarViews(Landroid/widget/RemoteViews;[ILandroid/app/PendingIntent;)Z
    ...
    .line 6
    :try_start_0
    iget-object p1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:Ld;

    iget-object p2, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lc;

    invoke-interface {p1, p2, v0}, Ld;->updateVisuals(Lc;Landroid/os/Bundle;)Z
...
.method public setToolbarItem(ILandroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    iget-object p3, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lc;

    invoke-interface {p2, p3, p1}, Ld;->updateVisuals(Lc;Landroid/os/Bundle;)Z
...
.method public validateRelationship(ILandroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    invoke-interface {v1, v2, p1, p2, p3}, Ld;->validateRelationship(Lc;ILandroid/net/Uri;Landroid/os/Bundle;)Z
