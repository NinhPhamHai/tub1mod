...
.method private newSessionInternal(Lc;Landroid/app/PendingIntent;)Z
    .locals 4
    .param p1    # Lc;
    ...
    invoke-direct {v0, p1, p2}, Landroidx/browser/customtabs/CustomTabsSessionToken;-><init>(Lc;Landroid/app/PendingIntent;)V
    ...
    invoke-direct {v1, p0, v0}, Ls;-><init>(Landroidx/browser/customtabs/CustomTabsService$1;Landroidx/browser/customtabs/CustomTabsSessionToken;)V
...
# virtual methods
.method public synthetic c0(Landroidx/browser/customtabs/CustomTabsSessionToken;)V
    .locals 1
...
.method public mayLaunchUrl(Lc;Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
    .locals 3
    .param p1    # Lc;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-direct {v1, p1, v2}, Landroidx/browser/customtabs/CustomTabsSessionToken;-><init>(Lc;Landroid/app/PendingIntent;)V
...
.method public newSession(Lc;)Z
    ...
    .line 1
    invoke-direct {p0, p1, v0}, Landroidx/browser/customtabs/CustomTabsService$1;->newSessionInternal(Lc;Landroid/app/PendingIntent;)Z
...
.method public newSessionWithExtras(Lc;Landroid/os/Bundle;)Z
    .locals 0
    .param p1    # Lc;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {p0, p1, p2}, Landroidx/browser/customtabs/CustomTabsService$1;->newSessionInternal(Lc;Landroid/app/PendingIntent;)Z
...
.method public postMessage(Lc;Ljava/lang/String;Landroid/os/Bundle;)I
    .locals 3
    .param p1    # Lc;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public receiveFile(Lc;Landroid/net/Uri;ILandroid/os/Bundle;)Z
    .locals 3
    .param p1    # Lc;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public requestPostMessageChannel(Lc;Landroid/net/Uri;)Z
    .locals 3
    .param p1    # Lc;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public requestPostMessageChannelWithExtras(Lc;Landroid/net/Uri;Landroid/os/Bundle;)Z
    .locals 2
    .param p1    # Lc;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {v1, p1, p3}, Landroidx/browser/customtabs/CustomTabsSessionToken;-><init>(Lc;Landroid/app/PendingIntent;)V
...
.method public updateVisuals(Lc;Landroid/os/Bundle;)Z
    .locals 3
    .param p1    # Lc;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public validateRelationship(Lc;ILandroid/net/Uri;Landroid/os/Bundle;)Z
    .locals 3
    .param p1    # Lc;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
