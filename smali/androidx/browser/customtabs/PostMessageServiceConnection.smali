...
.field public mService:Le;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field

.field public final mSessionBinder:Lc;
...
.method public constructor <init>(Landroidx/browser/customtabs/CustomTabsSessionToken;)V
    ...
    iput-object p1, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mSessionBinder:Lc;
...
.method private isBoundToService()Z
    ...
    .line 1
    iget-object v0, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mService:Le;
...
.method private notifyMessageChannelReadyInternal(Landroid/os/Bundle;)Z
    ...
    .line 3
    :try_start_0
    iget-object v2, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mService:Le;

    iget-object v3, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mSessionBinder:Lc;

    invoke-interface {v2, v3, p1}, Le;->onMessageChannelReady(Lc;Landroid/os/Bundle;)V
    :try_end_0
...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    .line 1
    invoke-static {p2}, Le$a;->asInterface(Landroid/os/IBinder;)Le;

    move-result-object p1

    iput-object p1, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mService:Le;
...
.method public final postMessage(Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    invoke-interface {v2, v3, p1, p2}, Le;->onPostMessage(Lc;Ljava/lang/String;Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
