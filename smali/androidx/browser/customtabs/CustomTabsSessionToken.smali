...
.field public final mCallbackBinder:Lc;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
# direct methods
.method public constructor <init>(Lc;Landroid/app/PendingIntent;)V
    .locals 0
    .param p1    # Lc;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    :cond_1
    :goto_0
    iput-object p1, p0, Landroidx/browser/customtabs/CustomTabsSessionToken;->mCallbackBinder:Lc;
...
.method public static createMockSessionTokenForTesting()Landroidx/browser/customtabs/CustomTabsSessionToken;
    ...
    invoke-direct {v0, v1, v2}, Landroidx/browser/customtabs/CustomTabsSessionToken;-><init>(Lc;Landroid/app/PendingIntent;)V
...
.method private getCallbackBinderAssertNotNull()Landroid/os/IBinder;
    ...
    .line 1
    iget-object v0, p0, Landroidx/browser/customtabs/CustomTabsSessionToken;->mCallbackBinder:Lc;
...
.method public static getSessionTokenFromIntent(Landroid/content/Intent;)Landroidx/browser/customtabs/CustomTabsSessionToken;
    ...
    .line 4
    :cond_2
    invoke-static {v0}, Lc$a;->asInterface(Landroid/os/IBinder;)Lc;
    ...
    invoke-direct {v0, v1, p0}, Landroidx/browser/customtabs/CustomTabsSessionToken;-><init>(Lc;Landroid/app/PendingIntent;)V
